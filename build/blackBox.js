...
function getNameCountryInThePath(paths, countriesData, isIslandOrContinent) {
    let path = '';
...
function findRoute(graph, startCountry, endCountry, countReq = 0, visited = new Set(), maxSteps = 14) {
