...
import { ICountry,getCCA3ByNameCountry, calcPath, loadCountriesData, totalRequest } from './blackBox.js';
...
function managmentControl(disbled:boolean, ...controls:Array<HTMLInputElement | HTMLButtonElement>) : void
{
...
(async () =>
{
    ...
    let countriesData: {[key:string]: ICountry} = {};
    try
    {
